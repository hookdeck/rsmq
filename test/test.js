...
(function() {
  ...
  describe('Redis-Simple-Message-Queue Test', function() {
    ...
    describe('Promise Api', function() {
      ...
      it('should check the maxsize of the queue', function() {
        return rsmq.getQueueAttributesAsync({
          qname: queue3.name
        }).then(function(resp) {
    ...
    describe('Queues', function() {
      ...
      it('Should fail: Create a new queue with negative vt - using createQueueAsync', function() {
        return rsmq.createQueueAsync({
          ...
          message: "vt must be between 0 and 9999999000"
        });
      });
...
// we keep vt = 0 so we can query them again quickly
    ...
    describe('Custom queue key', function() {
      it('Send a message to queue1', function(done) {
        rsmq.sendMessage({
          qname: queue1.name,
          qkey: 'somekey',
          message: "Hello World"
      ...
      it('check message does not exists', function(done) {
        rsmq.messageExists({
          qname: queue1.name,
          qkey: 'otherkey'
        }, function(err, resp) {
